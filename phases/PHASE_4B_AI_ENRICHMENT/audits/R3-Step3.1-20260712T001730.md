...
- **Generated:** 2026-07-12T00:17:30.497841+00:00
...
| R3-U03 | _normalize_enrich_mode(invalid/garbage) -> None, no raise | **PASS** | Invalid values return None (caller falls back to default on_demand). Function lowercases but does not strip whitespace. |
...
- Status: **PASS**
- Expected: `{"garbage": null, "near_miss": null, "nonstring": null, "trailing_space": null}`
- Actual: `{"garbage": null, "near_miss": null, "nonstring": null, "trailing_space": null}`
- Notes: Invalid values return None (caller falls back to default on_demand). Function lowercases but does not strip whitespace.
